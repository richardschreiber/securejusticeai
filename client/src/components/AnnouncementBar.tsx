...
export function AnnouncementBar() {
  return (
    <a href="#contact" className="block bg-primary text-primary-foreground border-b border-border py-2 px-4 hover:bg-primary/90 transition-colors cursor-pointer">
